class CadastroPage < SitePrism::Page
    ...
    elements :state_options,'#uniform-id_state options'
    ...
    #@nomeVarialvel = instancia (ao terminar aexecução do seu escopo ela deixa de existir)
    #@@nomeVarialvel = classe (no ciclo de vida da classe)
    #$nomeVariavel = global
    ...
    def preencher_form_cadastro_com_dados_fixos
        ...
        address_field.set 'Rua A 123'
        city_field.set 'Porto'
        state_select.click
    ...
    def preencher_form_cadastro_com_dados_aleatorios
        title_fem_rd.set true
        ...
        option.click
        zip_code_field.set '56789'
        mobile_phone_field.set Faker::PhomeNumber.cell_phone_in_e164
        address_alias_field.set 'Casa'
    end
    ...
    def preencher_form_cadastro_com_dados_datafile
